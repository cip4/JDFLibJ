...
public class JDFNumberRangeListTest extends TestCase
{
	...
	public final void testInRange()
	{
		...
		try
		{
			rangeList = new JDFNumberRangeList(
					"0.4 1.6 ~ 2.7 3.6 ~ 6 77.5 ~ INF");
		} catch (DataFormatException dfe)
		{
	...
	public final void testIsPartOfRange()
	{
		...
		assertFalse("Bad isPartOfRange", rangeList
				.isPartOfRange(new JDFNumberRange(2.8, 3.0)));
		assertTrue("Bad isPartOfRange", rangeList
				.isPartOfRange(new JDFNumberRange(1.6, 2.7)));
	}
	...
	public final void testAppend()
	{
		...
		try
		{
			...
			copyRangeList = new JDFNumberRangeList(
					"0 4~5 5.7 6~6.5 6.6~7.7 8~9");
		} catch (DataFormatException dfe)
		{
			System.out.println(dfe.toString());
		}
