...
public class JDFDateTimeRangeTest extends TestCase
{
    ...
    public final void testJDFDateTimeRangeJDFDateTimeRange ()
    {
        try
        {
            JDFDateTimeRange r = new JDFDateTimeRange(new JDFDate("2004-12-01T09:30:00Z"), 
            ...
            int duration = (int) ((test_r.getRight().getTimeInMillis() - test_r.getLeft()
    ...
    // assertFalse("Bad setString: ", rangelist.inRange(new JDFDate("PT1H25M")));
    ...
    public final void testInRange ()
    {
        try
        {
            JDFDateTimeRangeList rangelist = 
                new JDFDateTimeRangeList("2004-11-30T09:30:00Z ~ 2004-12-05T09:00:00Z");
