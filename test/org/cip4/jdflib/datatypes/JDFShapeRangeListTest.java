...
public class JDFShapeRangeListTest extends TestCase
{
	...
	public final void testAppendJDFShapeRange()
	{
		...
		assertEquals("original rangeList wrong:", rangeList.toString(),
				"0 0 3 1 2 3 ~ 4 5 6 4 2 3 ~ 4 5 6 7.5 8.5 9.5");
	...
	public final void testInRange()
	{
		...
		assertFalse("Bad setString: ", rangelist.inRange(new JDFShape(10, 12,
				12)));
	}
	...
	public final void testIsPartOfRange()
	{
		...
		assertTrue("Bad setString: ", rangelist
				.isPartOfRange(new JDFShapeRange(new JDFShape(3, 4, 5),
						new JDFShape(4, 5, 6))));
		assertTrue("Bad setString: ", rangelist
				.isPartOfRange(new JDFShapeRange(new JDFShape(9, 9, 9),
						new JDFShape(10, 10, 10))));
		assertFalse("Bad setString: ", rangelist
				.isPartOfRange(new JDFShapeRange(new JDFShape(9, 9, 9),
						new JDFShape(12, 12, 12))));
		assertFalse("Bad setString: ", rangelist
				.isPartOfRange(new JDFShapeRange(new JDFShape(4, 5, 6),
						new JDFShape(7, 8, 9))));
	}
	...
	public final void testIsList_False()
	{
		...
		try
		{
			...
			rangelist.append(new JDFShapeRange(new JDFShape("0 0 5"),
					new JDFShape("0 0 6")));
	...
	public final void testIsOrdered_False()
	{
		...
		try
		{
			...
			rangelist.append(new JDFShapeRange(new JDFShape("0 0 5.5"),
					new JDFShape("0 0 6")));
			rangelist.append(new JDFShape("0 0 5"));
			rangelist.append(new JDFShape("0 0 7"));
		} catch (DataFormatException dfe)
