...
public class UtilGeneratorTest extends TestCase
{
	...
	// /*
	// * Test method for
	// 'org.cip4.jdflib.generator.GeneratorUtil.getVersionInfo(String, String,
	// String)'
	// */
	...
	/*
	 * Test method for
	 * 'org.cip4.jdflib.generator.GeneratorUtil.getVersionInfo(Boolean, String,
	 * String, String)'
	 */
	public void testGetVersionInfoBooleanStringStringString()
	{
		...
		String maxOccurs1 = "1";
		System.out
				.println("First   Last    2-required-0  3-optional-0  5-required-1  6-optional-1\n");
		for (int i = 0; i < 8; i++)
		{
			first = "1." + i;
			for (int j = i; j < 8; j++)
			{
				...
				System.out.println(" "
						...
						+ last
						+ "      "
						+ GeneratorUtil.getVersionInfoElements(false, first,
								last, maxOccurs0)
						+ "      "
						+ GeneratorUtil.getVersionInfoElements(true, first,
								last, maxOccurs0)
						+ "      "
						+ GeneratorUtil.getVersionInfoElements(false, first,
								last, maxOccurs1)
