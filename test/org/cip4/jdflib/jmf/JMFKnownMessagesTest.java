...
public class JMFKnownMessagesTest extends JDFTestCaseBase
{
	public void testJMFDevCaps()
	{
		...
		for (int i = 0; i < 3; i++)
		{
			...
			XMLDoc report = JDFDeviceCap.getJMFInfo(jmf, r,
					EnumFitsValue.Allowed, EnumValidationLevel.Complete, true);
		...
		}
		{
			...
			docJMF.write2File(sm_dirTestDataTemp + "JMFDevCapTest.jmf", 2,
					false);

		}
		XMLDoc report = JDFDeviceCap.getJMFInfo(jmf, r, EnumFitsValue.Allowed,
		...
		report = JDFDeviceCap.getJMFInfo(jmf, r, EnumFitsValue.Allowed,
				EnumValidationLevel.Complete, true);
