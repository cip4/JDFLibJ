...
public class StrippingTest extends JDFTestCaseBase
{
	...
	public void testDieLayoutStrip() throws Exception
	{
		...
		JDFPreview pv0 = (JDFPreview) n.addResource(ElementName.PREVIEW, null,
		...
		for (int i = 0; i < 3; i++)
		{
			...
			JDFPreview pv = (JDFPreview) pv0.addPartition(
					EnumPartIDKey.CellIndex, index[i]);
	...
	public void testStripMarks() throws Exception
	{
				...
				.addPartition(EnumPartIDKey.SheetName, "Sheet_1");
		{
			...
			sm1
					.appendElement(ElementName.COLORCONTROLSTRIP)
					.setXMLComment(
							"The various explicit mark elements should be allowed here for their associated metatdata");
		}

		JDFStrippingParams spBS1 = (JDFStrippingParams) spS1.addPartition(
				EnumPartIDKey.BinderySignatureName, "BS_1");
		...
		posBS1_1.setRelativeBox(new JDFRectangle(0, 0, 0.5, 1));
		{
			...
			sm1_1
					.appendElement(ElementName.CUTMARK)
					.setXMLComment(
							"The various explicit mark elements should be allowed here for their associated metatdata");
		}
		// TODO page cs vs. cell cs
		{
			...
			sm1_2
					.appendElement(ElementName.IDENTIFICATIONFIELD)
					.setXMLComment(
							"The various explicit mark elements should be allowed here for their associated metatdata");
		}
		...
		JDFStrippingParams spBS2 = (JDFStrippingParams) spS1.addPartition(
				EnumPartIDKey.BinderySignatureName, "BS_2");
...

		{
			...
			sm2_2
					.setXMLComment("The following is a relatively positioned stripmark.");
			...
			sm2_2
					.appendElement(ElementName.REGISTERMARK)
					.setXMLComment(
							"The various explicit mark elements should be allowed here for their associated metatdata");
			setNextAnchor(
					sm2_2,
		...
		d.write2File(sm_dirTestDataTemp + File.separator + "StripMarks.jdf", 2,
				false);
