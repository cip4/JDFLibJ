...
/** Testing class for PrintfFormat. Run the <tt>main</tt>
...
public class PrintfFormatTest extends JDFTestCaseBase
{
    ...
    static public void main(String[] args)
    {
        ...
        if (testTiming)
        {
            try
            {
                ...
                texec = (1000 * (t1 - t0)) / (double) (niter * nsamp);
                System.out.println(
                    "Typical time for PrintfFormat.tostr(double): " + texec +
                    " usec");
            }
            catch (Exception e)
            {
    ...
    {
        test("foo%gbar", 'g', "foo", "bar", 0, -1, false, false, false,
            false, false);
        test("fo%%o%#0- +10.4gbar%%", 'g', "fo%o", "bar%", 10, 4, true,
            false, true, false, true);
        test("foo%%%9.0d%%bar", 'd', "foo%", "%bar", 9, 0, false, false,
            false, false, false);
        test("foo%%%9d%%bar", 'd', "foo%", "%bar", 9, -1, false, false,
            false, false, false);
        test("%9d", 'd', "", "", 9, -1, false, false, false, false,
            false);
        test("%X", 'X', "", "", 0, -1, false, false, false, false,
            false);
        test("%#X", 'X', "", "", 0, -1, true, false, false, false,
            false);
        test("%0X", 'X', "", "", 0, -1, false, true, false, false,
            false);
        test("%-X", 'X', "", "", 0, -1, false, false, true, false,
            false);
        test("% X%%%%", 'X', "", "%%", 0, -1, false, false, false, true,
            false);
        test("%%%+X%%", 'X', "%", "%", 0, -1, false, false, false,
            false, true);
        test("%045X", 'X', "", "", 45, -1, false, true, false, false,
            false);
        ...
        test(y, "y=|%-+20.5f|", "y=|+123.00000          |");
        test(z, "z=|%20.5f|",
            "z=|1234500000000000000000000000000.00000|");
    ...
    static void test(String s, char type, String pfx, String sfx, int w, int p,
        boolean alt, boolean zeropad, boolean left, boolean blank, boolean sign)
    {
