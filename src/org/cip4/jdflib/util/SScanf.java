...
public class SScanf extends ScanfReader implements Iterator
{
    ...
    {
        if("dxoi".indexOf(fmt.type)>=0) // also gracefully handle int as double
            return scanLong(fmt);
    ...
    /**
     * returns the next Object (@see the constructor), null if the string has been completely parsed or an invalid format
     * is scanned
     */
    public Object next()
    {
