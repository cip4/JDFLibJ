...
public class JDFComChannel extends JDFAutoComChannel
{
	...
	public static class EnumChannelTypeDetails extends ValuedEnum
	{
		...
		{
			return (EnumChannelTypeDetails) getEnum(
					EnumChannelTypeDetails.class, enumName);
		}

		public static EnumChannelTypeDetails getEnum(int enumValue)
		{
			return (EnumChannelTypeDetails) getEnum(
					EnumChannelTypeDetails.class, enumValue);
		}
		 ...
		 */
		public static final EnumChannelTypeDetails Unknown = new EnumChannelTypeDetails(
				"Unknown");
		public static final EnumChannelTypeDetails LandLine = new EnumChannelTypeDetails(
				"LandLine");
		public static final EnumChannelTypeDetails Mobile = new EnumChannelTypeDetails(
				"Mobile");
		public static final EnumChannelTypeDetails Secure = new EnumChannelTypeDetails(
				"Secure");
		public static final EnumChannelTypeDetails ISDN = new EnumChannelTypeDetails(
				"ISDN");
		public static final EnumChannelTypeDetails Form = new EnumChannelTypeDetails(
				"Form");
		public static final EnumChannelTypeDetails Target = new EnumChannelTypeDetails(
				"Target");
	}
	 ...
	 * @param qualifiedName
	 */
	public JDFComChannel(CoreDocumentImpl myOwnerDocument,
	...
	/**
	 * sets locator to the string specified in eMail, checking valid email
	...
	/**
	 * get the email address of this, if this is an email address, else null any
	 * "mailto" is stripped
	 * 
	 * @return
	 */
	...
	/**
	 * set the phone number of this, if this is a valid phone url, "tel:" or
	 * "fax:" is prepended, if it is not yet there
	 * 
	 * @param phone
	 *            the phone number string
	 * @param replaceForBlank
	 *            the replacement char for non-leading blanks , typically "." or
	 *            null are a good idea
	 * @param channelType
	 *            the channelType - must be either Fax or Phone
	 * @throws IllegalArgumentException
