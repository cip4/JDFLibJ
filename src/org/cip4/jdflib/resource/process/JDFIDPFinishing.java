...
public class JDFIDPFinishing extends JDFAutoIDPFinishing
{
	 ...
	 * @throws DOMException
	 */
	public JDFIDPFinishing(CoreDocumentImpl myOwnerDocument,
	 ...
	 * i=0;i<value.size();i++) { v.push_back(KString(value[i])); }
	 ...
	 * for(int i=0;i<v.size();i++) { vi.push_back((int)v[i]); } return vi; }
	 */
	/**
