...
public class JDFCutBlock extends JDFAutoCutBlock
{
	...
	static
	{
		atrInfoTable[0] = new AtrInfoTable(AttributeName.BLOCKNAME, 0x22222222,
	 ...
	 * @throws DOMException
	 */
	public JDFCutBlock(CoreDocumentImpl myOwnerDocument, String qualifiedName)
			throws DOMException
	{
	 ...
	 * @throws DOMException
	 */
	public JDFCutBlock(CoreDocumentImpl myOwnerDocument, String myNamespaceURI,
	...
	/**
	 * get the vector of implicitly define partition keys that MUST NOT be used
	 * in the resource
	 */
	@Override
