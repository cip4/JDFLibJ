...
public abstract class ValuedEnum extends Enum
{
	...
	protected static Enum getEnum(final Class enumClass, final int value)
	{
		...
		{
			final ValuedEnum enumeration = (ValuedEnum) it.next();
	...
	private int getValueInOtherClassLoader(final Object other)
	{
		try
		{
			final Method mth = other.getClass().getMethod("getValue", null);
			final Integer value = (Integer) mth.invoke(other, null);
