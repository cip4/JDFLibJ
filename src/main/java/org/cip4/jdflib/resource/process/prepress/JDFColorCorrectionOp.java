...
public class JDFColorCorrectionOp extends JDFAutoColorCorrectionOp
{
	 ...
	 * @param qualifiedName
	 */
	public JDFColorCorrectionOp(final CoreDocumentImpl myOwnerDocument, final String qualifiedName)
	{
	 ...
	 * @param qualifiedName
	 */
	public JDFColorCorrectionOp(final CoreDocumentImpl myOwnerDocument, final String myNamespaceURI, final String qualifiedName)
	{
	 ...
	 * @param localName
	 */
	public JDFColorCorrectionOp(final CoreDocumentImpl myOwnerDocument, final String myNamespaceURI, final String qualifiedName, final String myLocalName)
	{
	 ...
	 *
	 * @return JDFFileSpec the matching AbstractProfile element or null if
	 *         nothing was found
	 */
	public JDFFileSpec getAbstractProfile()
	{
		final VElement v = getChildElementVector(ElementName.FILESPEC, null, new JDFAttributeMap(), true, 0, false);
	 ...
	 *
	 * @return JDFFileSpec the matching DeviceLinkProfile element or null if
	 *         nothing was found
	 */
	...
	/**
	 * Gets of 'this' child FileSpec(DeviceLinkProfile) element, optionally
	 * creates it, if it doesn't exist.
	 *
