...
public class JDFFeaturePool extends JDFAutoFeaturePool
{
	 ...
	 * @throws DOMException
	 */
	public JDFFeaturePool(final CoreDocumentImpl myOwnerDocument, final String qualifiedName) throws DOMException
	{
	 ...
	 * @throws DOMException
	 */
	public JDFFeaturePool(final CoreDocumentImpl myOwnerDocument, final String myNamespaceURI, final String qualifiedName) throws DOMException
	{
	 ...
	 * @throws DOMException
	 */
	public JDFFeaturePool(final CoreDocumentImpl myOwnerDocument, final String myNamespaceURI, final String qualifiedName, final String myLocalName) throws DOMException
	{
