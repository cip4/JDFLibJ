...
public class GeneratorUtil
{
	 ...
	 */
	public static boolean isElementToAdd(String elementName, String complexTypeName)
	{
		...
		if (elementName.endsWith("Update"))
		{
			...
			isValid = false;
				...
				|| "CommandTypeObj".equals(elementName) || "CommandOrQueryTypeObj".equals(elementName) || "JDF".equals(elementName) || "Location".equals(elementName)
				|| "FoldOperation".equals(elementName) || "NotificationDetails".equals(elementName))
		{
	 ...
	 */
	public static SchemaComplexType getAllValidAttributes(KElement schemaElement, Vector vComplexTypes, VElement vSimpleType, String[] parents, VElement vAppInfoElements, SchemaComplexType complexType)
	{
		String complexTypeName = complexType.m_SchemaComplexTypeName;

		VElement vAttributes = collectAllAttributes(schemaElement, complexType, vComplexTypes, complexTypeName);
	...
	private static VElement collectAllAttributes(KElement schemaElement, SchemaComplexType complexType, Vector vComplexTypes, String complexTypeName)
	{
		KElement nKElement;
		...
		if (complexContent != null || "Comment".equals(complexTypeName))
		{
			...
			if ("ContentObject".equals(complexTypeName) || "MarkObject".equals(complexTypeName))
			{
				for (int i = 0; i < vComplexTypes.size(); i++)
				{
					...
					{
						SchemaComplexType schemaCom = new SchemaComplexType(myComplexType.m_kElem.getXPathElement("./xs:complexContent/xs:extension"));
		...
		VElement vAttributesGroup = nKElement.getChildrenByTagName("xs:attributeGroup", "", new JDFAttributeMap(), true, true, 0);
	...
	private static void fillAttributeIntoComplexType(KElement attribute, String complexTypeName, String[] parents, VElement vAppInfoElements, VElement vSimpleType, SchemaComplexType complexType)
	{
	 ...
	 */
	public static SchemaComplexType getAllValidElements(String[] parents, VElement vAppInfoElements, SchemaComplexType complexType)
	{
		...
		if (sequence != null)
		{
			...
			VElement vElements = sequence.getChildrenByTagName("xs:element", "", new JDFAttributeMap(), true, true, 0);

			VElement vElementsGroup = sequence.getChildrenByTagName("xs:group", "", new JDFAttributeMap(), true, true, 0);
	...
	private static void fillElementIntoComplexType(KElement element, String[] parents, VElement vAppInfoElements, String minOccurs, String maxOccurs, SchemaComplexType complexType)
	{
	...
	private static VElement groups2Attributes(VElement vAttributesGroup)
	{
		...
		while (attributesGroupIter.hasNext())
		{
			...
			{
				KElement nKElement = attributesGroup.getDocRoot().getChildWithAttribute("xs:attributeGroup", "name", "", ref, 0, false);

				if (nKElement != null)
				{
					VElement vAttributes = nKElement.getChildrenByTagName("xs:attribute", "", new JDFAttributeMap(), true, true, 0);
	...
	private static VElement groups2Elements(VElement vElementsGroup)
	{
		...
		while (elementsGroupIter.hasNext())
		{
			...
			{
				KElement nKElement = elementsGroup.getDocRoot().getChildWithAttribute("xs:group", "name", "", ref, 0, false);

				if (nKElement != null)
				{
					KElement seqElem = nKElement.getChildByTagName("xs:sequence", "", 0, new JDFAttributeMap(), true, true);
					VElement vElements = seqElem.getChildrenByTagName("xs:element", "", new JDFAttributeMap(), true, true, 0);
					v.addAll(vElements);
	 ...
	 */
	public static SchemaComplexType addElementUniqueToVector(SchemaComplexType nNewComplexType, SchemaComplexType nOldComplexType)
	{
	 ...
	 * @return SchemaComplexType - a complex type where all attributes from "nOldComplexType" are unique
	 */
	public static SchemaComplexType addAttributeUniqueToVector(SchemaComplexType nNewComplexType, SchemaComplexType nOldComplexType)
	{
	 ...
	 * @param vAppInfoElements
	 */
	public static SchemaComplexType getRestInfo(String[] parents, VElement vAppInfoElements, SchemaComplexType complexType)
	{
	...
	public static String getAttributeExt(SchemaAttribute schemaAttribute)
	{
		...
		boolean isEnum = JavaCoreStringUtil.useEnumAttribute(schemaAttribute.getIsEnum(), schemaAttribute.getStrAttributeName());

		AttributeInfo.EnumAttributeType at = AttributeInfo.EnumAttributeType.getEnum(strType);
	...
	public static SchemaComplexType getNodeUsageString(SchemaComplexType complexType, String[] parents, VElement vAppInfoElements)
	{
		String sUsage = "";
		String sMinOccurs = "";
		String sMaxOccurs = "";
	...
	public static void fillAppInfoElements(String motherOf, String[] parents, VElement vElements, VElement vAppInfoElements)
	{
	 ...
	 */
	private static void elementHandleMinMaxOccurs(String[] parents, VElement vAppInfoElements, SchemaElement schemaElement, SchemaComplexType complexType)
	{
		String parentsPath = "";
		if (parents != null)
		{
		...
		KElement complexTypeappInfoElement = complexType.m_kElem.getXPathElement("xs:annotation/xs:appinfo");
	...
	private static boolean elementSetMinMaxOccurs(SchemaElement schemaElement, final String parentsPath, final String elementName, final KElement appInfoElement)
	{
		boolean isMinMaxOccursInitialized = false;

		VElement vConstraintElements = appInfoElement.getChildrenByTagName("Constraint", "", new JDFAttributeMap(), true, true, 0);
	...
	public static void elementHandleVersion(String[] parents, VElement vAppInfoElements, SchemaElement schemaElement, SchemaComplexType complexType)
	{
		String parentsPath = "";
		if (parents != null)
		{
	...
	private static boolean elementSetVersion(SchemaElement schemaElement, final String parentsPath, final String elementName, final KElement appInfoElement)
	{
		boolean isVersionInitialized = false;
		VElement vVersionElements = appInfoElement.getChildrenByTagName("Version", "", new JDFAttributeMap(), true, true, 0);
	...
	{
		boolean result = parentsPath.equals(elementPath) || parentsPath.startsWith(elementPath + "/") || parentsPath.endsWith("/" + elementPath);
	...
	public static void attributeHandleVersion(String[] parents, VElement vAppInfoElements, SchemaAttribute schemaAttribute, SchemaComplexType complexType)
	{
		String parentsPath = "";
		if (parents != null)
		{
	...
	private static boolean attributeSetVersion(SchemaAttribute schemaAttribute, final String parentsPath, final String attributeName, final KElement appInfoElement)
	{
		boolean isVersionInitialized = false;
