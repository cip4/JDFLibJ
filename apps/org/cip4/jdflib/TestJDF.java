...
public class TestJDF
{
	...
	static protected final String sm_dirTestSchema = ".." + SEPARATOR
			+ "schema" + SEPARATOR + "Version_1_3" + SEPARATOR;
	static protected final String sm_dirTestData = "O:\\jdflibj\\test"
			+ SEPARATOR + "data" + SEPARATOR;
	static protected final String sm_dirTestDataTemp = sm_dirTestData + "temp"
			+ SEPARATOR;
	...
	public static void main(String[] argv)
	{
		...
		for (int i = 0; i < vL.size(); i++)
		{
			...
			// JDFResourceLink rl=(JDFResourceLink)
			// n.getResourceLinkPool().getChildWithAttribute("PreviewLink",
			// "rRef", null, "r080707_024519175_000439", 0, true);
			VJDFAttributeMap v = n.getExecutablePartitions(rl,
					EnumResStatus.Available, true);
