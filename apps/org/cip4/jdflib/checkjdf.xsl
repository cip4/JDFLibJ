...
<xsl:stylesheet exclude-result-prefixes="tbl" version="1.0" xmlns="http://www.w3.org/1999/xhtml" xmlns:tbl="urn:TheLanguageTable" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <tbl:lang>
    ...
    <tbl:loc key="NoJDF">
      <tbl:str lang="EN">No JDF Found for validation</tbl:str>
      <tbl:str lang="DE">Kein JDF zum validieren gefunden</tbl:str>
      <tbl:str lang="FR">Testing File: in French</tbl:str>
      <tbl:str lang="NL">No JDF Found for validation - TBD Translate in xslt</tbl:str>
    </tbl:loc>
  </tbl:lang>
  ...
  <!-- =============================================== -->
  <xsl:template match="CheckJDFOutput[@FoundJDF='false']">
    <div class="checkjdf">
      <h3 class="invalid">
        <xsl:call-template name="localize">
          <xsl:with-param name="string" select="'NoJDF'"/>
        </xsl:call-template>
      </h3>
      <ul>
        <xsl:apply-templates/>
